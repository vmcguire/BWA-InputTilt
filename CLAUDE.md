# BWA-InputTilt — read before doing anything

> ✅ **This is the CANONICAL home for BWA-InputTilt.** All serious DSP, IP, and
> process for this plugin live **here**, in `~/Developer/BWA-InputTilt/`. Author here — always.
>
...
> changes. This file deliberately holds only what is specific to BWA-InputTilt; every
...
4. **`docs/MARKET-PAIN-AND-ATTACKS.md`** — the row for **BWA-InputTilt**; internalize the pain + attack before any DSP.
...
Then cut a GitHub Release here (`vmcguire/BWA-InputTilt`) and attach the notarized `BWA-InputTilt.vst3`.
