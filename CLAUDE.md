...
> Do all work in the monorepo: **`~/Developer/bwa-fx-ecosystem/BWA-InputTilt/`**
...
```bash
git subtree push --prefix=BWA-InputTilt git@github.com:vmcguire/BWA-InputTilt.git main
```

Then cut a GitHub Release in this mirror and attach the notarized `BWA-InputTilt.vst3`.
